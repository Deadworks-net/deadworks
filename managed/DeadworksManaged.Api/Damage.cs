...
public sealed unsafe class CTakeDamageInfo : IDisposable {
	...
	/// <summary>
	/// The kind of damage (bullet, spirit, melee, ...). Starts as <see cref="ECitadelDamageType.None"/>; set it before
	/// <see cref="CBaseEntity.ApplyDamage"/> so the right resistances and modifiers apply.
	/// </summary>
